...
export const journeyTimeline: JourneyItem[] = [
  ...
  },
  {
    ...
    description:
      "Pursuing a 4-year undergraduate degree in Computer Science and Engineering with coursework focused on Data Structures, Algorithms, Database Systems, Computer Networks, Operating Systems, and Machine Learning.",
    highlights: [
